...
I can't really say I fully understand *why* this works: even if the moves and the blocks are the same, it seems like the *board* may change a lot between block n and block n + 1700.... also in terms of my coding style this definitely feels like the most hacky one so far (I ended up writing out my entire reasoning as formatted prints) but I was only focused on getting that second star. Now I want to go look a bit at how other people solved this. Only pasting the essential bit here; enjoy all the printf's...