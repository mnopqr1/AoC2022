...
* I did not notice until after solving the puzzle that the input has a special property: we always `ls` before we do `cd`. This makes it easier than I thought it would be, for example in the puzzle input there's never a `cd /` in the middle of the list of instructions (I abandoned my OCaml solution because I thought that was a possibility). Thanks to this, [some of my code](https://github.com/mnopqr1/AoC2022/blob/1f14e599970639f64506ecc13aa3dce51cad7404/day7/day7.py#L21) miraculously works and never return `None`...
